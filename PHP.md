...
* [Slim](https://www.slimframework.com/) - Another simple micro framework. 【ongoing】
...
* [Smarty](http://www.smarty.net/) - A template engine to complement PHP. 【ok】
...
* [Couscous](http://couscous.io) - Couscous turns Markdown documentation into beautiful websites. It's GitHub Pages on steroids.【ongoing】
...
* [Guzzle]( https://github.com/guzzle/guzzle) - A comprehensive HTTP client.-【ok】
* [HTTPFul](https://github.com/nategood/httpful) - A chainable HTTP client.->【ongoing】
...
* [Embed](https://github.com/oscarotero/Embed) - An information extractor from any web service or page. 【ongoing】可以把url内容转换成表数据 
* [Goutte](https://github.com/FriendsOfPHP/Goutte) - A simple web scraper. 【ongoing】 基于事件的数据收集
...
* [Purl](https://github.com/jwage/purl) - A URL manipulation library. 【ongoing】
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) - Another mailer solution. 【ok】
...
* [Flysystem](https://github.com/thephpleague/Flysystem) - Another filesystem abstraction layer. 【ok】
...
* [PHP-DI](http://php-di.org/) - A dependency injection container that supports autowiring. 【ongoing】
...
* [Image Hash](https://github.com/jenssegers/imagehash) - A library for generating perceptual image hashes. 【ongoing】
...
* [PHP Image Workshop](https://github.com/Sybio/ImageWorkshop) - Another image manipulation library. 【ok】

## Testing
*Libraries for testing codebases and generating test data.*

* [Alice](https://github.com/nelmio/alice) - An expressive fixture generation library. 【ok】测试造数据，依赖于Faker
* [AspectMock](https://github.com/Codeception/AspectMock) - A mocking framework for PHPUnit/Codeception.
* [Atoum](https://github.com/atoum/atoum) - A simple testing library.
* [Behat](http://docs.behat.org/en/v2.5/) - A behaviour driven development (BDD) testing framework.【ok】行为测试
* [Codeception](https://github.com/Codeception/Codeception) - A full stack testing framework. 【ongoing】支持多种类型的广告创建操作
* [DBUnit](https://github.com/sebastianbergmann/dbunit) - A database testing library for PHPUnit. 【ok】
* [Faker](https://github.com/fzaninotto/Faker) - A fake data generator library.【ok】
